# use .fromkeys() to create a dictionary that has the consonants from the alphabet as its keys 
# and the string "consonant" as the value for each of those keys.  
...
var = fast_food_items.pop("McDonald's")
print(var)
# use .popitem() to remove the last key: value pair from the dictionary assigned to 
